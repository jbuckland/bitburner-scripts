...
export class SpiralizeMatrix implements IContractSolver {
    ...
    public type: CodingContractType = CodingContractType.spiralizeMatrix;

    constructor(private ns: NS) {
    }

    public solve(matrix: number[][]): string[] | number {
