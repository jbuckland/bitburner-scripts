...
import { DebugLevel, playerControllers, SCRIPTS, SCRIPTS_OLD_CONTROLLERS } from 'lib/consts';
import { crimeControllers } from 'lib/crime-consts';
import { prepAllTargets, singleHack, useAvailableRunnersForWork } from 'lib/hack-utils';
import {
    debugLog,
    formatBigNumber,
    formatBigRam,
...
import { getAllTargetWorkInfo, isReadyForBatch, startBestController } from 'lib/utils-controller';
...
export async function main(ns: NS) {
    ...
    function runInitialScripts() {
        ...
        ns.run(SCRIPTS_OLD_CONTROLLERS.homeController);
        ns.run(SCRIPTS_OLD_CONTROLLERS.batchController);
        ns.run(SCRIPTS_OLD_CONTROLLERS.hacknet);
